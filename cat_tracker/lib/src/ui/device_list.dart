...
import '../ui/device_interactor_screen.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                    onPressed: !widget.scannerState.scanIsInProgress//initial state
                        ? () => widget.startScan([])//if scan not in progress, start scanning
                        : null,
